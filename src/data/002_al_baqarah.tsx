...
const data: DataType = {
  ...
  verses: {
    ...
    262: {
      helper: 'اَلَّذِيْنَ يُنْفِقُوْنَ',
      full:
    ...
    266: {
      helper: 'اَيَوَدُّ اَحَدُكُمْ',
      full:
        'اَيَوَدُّ اَحَدُكُمْ اَنْ تَكُوْنَ لَهٗ جَنَّةٌ مِّنْ نَّخِيْلٍ وَّاَعْنَابٍ تَجْرِيْ مِنْ تَحْتِهَا الْاَنْهٰرُۙ لَهٗ فِيْهَا مِنْ كُلِّ الثَّمَرٰتِۙ وَاَصَابَهُ الْكِبَرُ وَلَهٗ ذُرِّيَّةٌ ضُعَفَاۤءُۚ فَاَصَابَهَآ اِعْصَارٌ فِيْهِ نَارٌ فَاحْتَرَقَتْ ۗ كَذٰلِكَ يُبَيِّنُ اللّٰهُ لَكُمُ الْاٰيٰتِ لَعَلَّكُمْ تَتَفَكَّرُوْنَ',
    },
    267: {
      helper: 'يٰٓاَيُّهَا الَّذِيْنَ',
      full:
    ...
    273: {
      helper: 'لِلْفُقَرَاۤءِ',
      full:
        'لِلْفُقَرَاۤءِ الَّذِيْنَ اُحْصِرُوْا فِيْ سَبِيْلِ اللّٰهِ لَا يَسْتَطِيْعُوْنَ ضَرْبًا فِى الْاَرْضِۖ يَحْسَبُهُمُ الْجَاهِلُ اَغْنِيَاۤءَ مِنَ التَّعَفُّفِۚ تَعْرِفُهُمْ بِسِيْمٰهُمْۚ لَا يَسْـَٔلُوْنَ النَّاسَ اِلْحَافًا ۗوَمَا تُنْفِقُوْا مِنْ خَيْرٍ فَاِنَّ اللّٰهَ بِهٖ عَلِيْمٌ',
    },
    274: {
      helper: 'اَلَّذِيْنَ يُنْفِقُوْنَ',
      full:
    ...
    275: {
      helper: 'اَلَّذِيْنَ يَأْكُلُوْنَ',
      full:
    ...
    279: {
      helper: 'فَاِنْ لَّمْ تَفْعَلُوْا',
      full:
    ...
    280: {
      helper: 'وَاِنْ كَانَ ذُوْ',
      full:
        'وَاِنْ كَانَ ذُوْ عُسْرَةٍ فَنَظِرَةٌ اِلٰى مَيْسَرَةٍ ۗ وَاَنْ تَصَدَّقُوْا خَيْرٌ لَّكُمْ اِنْ كُنْتُمْ تَعْلَمُوْنَ',
    },
    281: {
      helper: 'وَاتَّقُوْا يَوْمًا',
      full:
        'وَاتَّقُوْا يَوْمًا تُرْجَعُوْنَ فِيْهِ اِلَى اللّٰهِ ۗثُمَّ تُوَفّٰى كُلُّ نَفْسٍ مَّا كَسَبَتْ وَهُمْ لَا يُظْلَمُوْنَ',
    },
    282: {
      helper: 'يٰٓاَيُّهَا الَّذِيْنَ اٰمَنُوْٓا',
      full:
    ...
    284: {
      helper: 'لِلّٰهِ مَا فِى السَّمٰوٰتِ',
      full:
